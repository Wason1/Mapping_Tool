...
from tkinter import Tk, filedialog, StringVar, END, messagebox, OptionMenu, Button, DISABLED, NORMAL, Listbox
...
class Application:
    def __init__(self, master):
        ...
        self.listbox = Listbox(master)  # Use a Listbox for displaying matches
    ...
    def next_item(self):
        if self.matches and self.next_item_index < len(self.matches):
            ...
            self.listbox.insert(END, f"Matches for '{item}':")
