...
def load_spreadsheet(application, spreadsheet_number):
    ...
    if filename:
        if spreadsheet_number == 1:
            ...
            application.update_dropdown(application.dropdown1, df_1.columns, application.column_button1)
            ...
            application.update_dropdown(application.dropdown2, df_2.columns, application.column_button2)
